...
function Landing() {
  return (
    ...
    <div className="flex flex-col justify-start items-start w-screen flex-grow gap-7" style={{ height: 'calc(100vh - 4rem)' }}>
      ...
      <div className="bg-deltaquad min-h-[50%] max-h-screen xl:h-screen max-w-full min-w-full bg-cover flex justify-start items-start mt-44 md:mt-auto ml-auto transition-ease duration-100">
      </div>
      ...
      <div className="flex flex-col items-center justify-center my-32 sm:my-40">
        <p className="max-w-xs md:max-w-md lg:max-w-lg min-h-24 text-center text-2xl font-regular leading-loose tracking-wide">We serve clients worldwide, providing specialised solutions to unique problems.</p>
      </div>
      <LandingIcons/>
      <LandingWorkWithUs/>
    </div>
