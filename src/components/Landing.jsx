...
function Landing() {
  return (
    ...
    <div className="flex flex-col justify-start items-start w-screen flex-grow gap-7" style={{ height: 'calc(100vh - 4rem)' }}>
      ...
      <br/>
      <span className="vertical-align py-8 px-16 lg:p-0 w-full sm:ml-16 lg:ml-40 mt-[25rem] sm:mt-[36rem] md:mt-[36rem] lg:mt-[40rem] sm:w-[28rem] text-md sm:text-md md:text-lg font-rajdhani font-thin leading-20 tracking-wide  text-ft-white">
      ...
      <div className="bg-deltaquad h-1/3 sm:h-1/3 lg:h-2/3 xl:h-screen lg:max-h-full max-w-[780px] md:max-w-[1366px] lg:max-w-full bg-cover w-screen flex justify-start items-start mt-44 md:mt-56 lg:mt-0 ml-auto">
      </div>
