...
function Landing() {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        <div className="">
          <div className="vertical-align mt-24 px-12 sm:pt-12 sm:p-0 sm:ml-16 md:ml-24 lg:ml-36 w-3/4 overflow-visible lg:w-1/3 h-fit text-4xl sm:text-7xl font-rajdhani font-regular uppercase leading-20 tracking-widest text-ft-white items-center transition-ease duration-300">
        ...
        <br />
        <div className="vertical-align absolute-bottom mb-8 md:mb-24 p-12 sm:p-0 lg:p-0 w-full sm:ml-16 lg:ml-36 max-sm:mt-[28rem] sm:mt-[36rem] md:mt-[36rem] lg:mt-[40rem] sm:w-[30rem] text-normal font-rajdhani font-light leading-20 tracking-wide  text-ft-white transition-ease duration-300 font-['Inter']">
          ...
          <div className="flex flex-col xl:flex-row md:p-12">
            ...
            <div className="flex flex-col md:justify-center md:items-start xl:p-12 xl:w-[38rem]">
              ...
              <div className="max-md:flex max-md:justify-center">
                <button className="bg-ft-dark-grey uppercase rounded-3xl flex items-center justify-center w-72 h-8 sm:w-44 min-h-[2.75rem] text-base font-semibold leading-tight tracking-widest my-8 md:mx-6 hover:opacity-90 hover:bg-black transition duration-300">
