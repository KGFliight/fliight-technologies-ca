...
function Footer() {
  return (
    <footer className="border-ft-dark-grey">
      ...
      <div className="flex flex-col bg-gray-700 w-screen mb-4 py-8 px-6 gap-3">
      ...
      <div className="px-12 mb-12 text-xs text-ft-grey font-normal leading-loose tracking-wide">
        <span className="">© Fliight Technologies Pty Ltd. All rights reserved. </span>
        <br/>
        <span>Website by jbdev</span>
      </div>
    </footer>
  )
}
