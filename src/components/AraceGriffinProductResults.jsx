...
const result = [
  ...
  },
  {
    ...
    description:
      'Demonstration of long range powerline feeder inspections in a post disaster trial. The Griffin pro can fly for 2.5 hours, covering 140+ km. Data collected with Nextvision Colibri2 ISR payload.',
    url: 'https://dyupn21s2frgg.cloudfront.net/Griffin_Pro_Inspection.mp4',
  },
  {
    type: 'image',
    image: resultsReviewThumbnail,
    alt: 'Griffin Pro Review by ArduPilot Pioneer, Dr Andrew Tridgell',
    title: 'Griffin Pro Review by ArduPilot Pioneer, Dr Andrew Tridgell',
    description:
      'Discover what industry experts are saying about the Arace Griffin Pro. Read this in-depth, honest review highlighting the quadplane’s advanced capabilities, impressive performance, and innovative design for demanding missions.',
    url: 'https://discuss.ardupilot.org/t/review-of-arace-griffinpro-quadplane/93893',
  },
]

function AraceGriffinProductResults() {
...
export default AraceGriffinProductResults
