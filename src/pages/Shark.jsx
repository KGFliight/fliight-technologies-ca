  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-ft-black bg-opacity-50 z-50">
          <div className="bg-ft-white p-4 rounded shadow-lg text-center w-[80%]">
            <p className="text-ft-black">
              Please note that this is not optimised for mobile, please access
              on PC for a better experience.
            </p>
            <button
      ...
      <div className="flex-grow">
        <iframe
          src="https://glitch.com/embed/#!/embed/sls-bvlos-shark?path=README.md&previewSize=100"
          title="sls-bvlos-shark on Glitch"
